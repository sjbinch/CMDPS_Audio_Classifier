...
class CMDPS_binary(td.Dataset):
    ...
    def __init__(self,
        ...
        super(CMDPS_binary, self).__init__()

        self.sample_rate = sample_rate

        meta = self.load_meta(os.path.join(root, 'meta', 'meta_binary.csv'))
...
class CMDPS_multi(td.Dataset):
    ...
    def __init__(self,
        ...
        super(CMDPS_multi, self).__init__()

        self.sample_rate = sample_rate

        meta = self.load_meta(os.path.join(root, 'meta', 'meta_multi.csv'))
